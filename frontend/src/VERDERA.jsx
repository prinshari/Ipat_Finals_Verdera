...
const Pangilinan = () => {
  ...
  useEffect(() => {
    ...
    if (storedUser && storedRole && storedToken) {
      ...
      // If the user is not vice, redirect them
      if (storedRole !== "vice") {
        console.log("Not Vice, redirecting to admin3...");
        setTimeout(() => navigate("/admin3"), 0);
      }
    } else {
